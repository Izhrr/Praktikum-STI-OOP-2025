/*
    ...
    Deskripsi Program       : Melengkapi Class Bacteria yang mengimplementasikan BacteriaBehaviour
*/
...
public abstract class Bacteria implements BacteriaBehaviour {
    ...
    public void reproduce(int days, double effectiveModifier) {
        currentPopulation = currentPopulation + (int)(currentPopulation*days*growthRate*effectiveModifier);
    }
