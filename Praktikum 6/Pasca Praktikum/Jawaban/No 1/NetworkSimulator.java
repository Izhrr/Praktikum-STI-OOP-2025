...
/**
    ...
    public static void validatePacket(List<Node> nodes, Map<String, Set<Integer>> transmissionLog, Packet packet) throws NetworkException {
        ...
        // Validasi apakah node sumber dan tujuan ada
        if (fromNode == null || toNode == null) {
            throw new NetworkException();
        }

        // Validasi loopback (kirim ke diri sendiri)
        if (packet.from.equals(packet.to)) {
            throw new LoopbackException("Loopback: Node " + packet.to + " tidak boleh mengirim ke dirinya sendiri.");
        }
 ...
 */
static class LoopbackException extends NetworkException {
 ...
 */
static class TimeDesyncException extends NetworkException {
 ...
 */
static class CollisionException extends NetworkException {
