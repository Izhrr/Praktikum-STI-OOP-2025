...
public class TungTungTungSahur {
    ...
    public void cook() {
        if(recipeSteps.isEmpty()){
            ...
            ICommandAction step = recipeSteps.get(0);
            step.execute();
    ...
    public void cancel() {
        if(completedSteps.isEmpty()){
            ...
            ICommandAction completedLastStep = completedSteps.get(completedSteps.size() - 1);
            completedLastStep.undo();
            completedSteps.remove(completedSteps.size() - 1);
            recipeSteps.add(0, completedLastStep);
        }
    }
