...
public class Knight extends Player {
    ...
    public void basicAttack(Enemy enemy) {
        ...
        enemy.setHP(enemy.getHP() - sharpness);
    }
    ...
    public void ultimateAttack(Enemy enemy) {
        ...
        enemy.setHP(enemy.getHP() - (sharpness*10));
    }
    ...
    //     Enemy enemy = new Enemy("EnemyTest", 100, 100);
    //     knight.printStatus();
    //     enemy.printStatus();
    //     knight.basicAttack(enemy);
    //     enemy.printStatus();
    // }
}
